...
const STEP_TITLES = {
  ...
  import: 'Поднимаем новую линию рядом с прежней',
  handshake: 'Ждём, когда новая линия обменяется ключами',
  promote: 'Переводим правила на новую линию',
  verify: 'Проверяем, каким адресом видно снаружи',
  retire: 'Выключаем прежнюю линию',
}
...
const START_ERRORS = {
  ...
  unknown_tunnel: 'Роутер не знает линию, выбранную для замены. Обновите экран линий и выберите заново.',
