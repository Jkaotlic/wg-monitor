...
func parseAWGMURLPatchArgs(args []string) (awgmURLPatchOptions, error) {
	...
	fs.StringVar(&opts.OldURL, "old", "https://wgmonitor.jkaotlic.duckdns.org", "old backend URL")
	fs.StringVar(&opts.NewURL, "new", "https://wgmonitor.anexaev.crazedns.ru", "new backend URL")
