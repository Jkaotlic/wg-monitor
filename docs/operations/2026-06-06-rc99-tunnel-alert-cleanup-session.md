...
- Online static agents updated to `v0.13.0-rc99`: `client-a`, `testkeen`, `client-i`, `del`, `gachimikhail`, `client-b`.
- Mobile/offline agents were queued for deferred update:
  - `client-g`: `93727cfc2a460a9735b5b70a525e88c4`
  - `client-f-old`: `82a65cf17f9cc9b6ee6cf9862c727635`
  - `client-e`: `a82d24d1454acd71d8b14a3bdf35c610`
...
- `client-a` remained a real router/tunnel outage after update, not a rollout problem: `0/4 running`, no handshakes.

## Follow-up

- Investigate `client-a` separately as a live tunnel/router outage.
