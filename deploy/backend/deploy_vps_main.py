...
def main() -> int:
    ...
    rc, out, _ = run(ssh, "curl -sS -o /dev/null -w '%{http_code}' https://wgmonitor.example.com/health", check=False)
    print(f"https://wgmonitor.example.com/health -> HTTP {out.strip()}")
