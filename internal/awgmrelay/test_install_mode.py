...
class DownloadResolveIPTest(unittest.TestCase):
    ...
    BASE = {
        ...
        "release_base": "https://wgmonitor.example.com/v1/releases/download",
        "expected_sha": "ab" * 32,
        "init_script": "#!/bin/sh\ntrue",
    }
    ...
    def test_resolve_ip_pins_curl_and_wget(self):
        s = self._script(download_resolve_ip="203.0.113.207")
        self.assertIn("RESOLVE_HOST='wgmonitor.example.com'", s)
        self.assertIn("RESOLVE_IP='203.0.113.207'", s)
