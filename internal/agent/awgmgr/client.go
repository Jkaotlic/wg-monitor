...
// isAwgmgrEndpointMissing and fall back to ndmc.
...
// isAwgmgrEndpointMissing reports whether err came from an awg-manager build
// that does not serve the requested endpoint, as opposed to a real failure.
// Only 404 qualifies: a 400 means the endpoint exists and rejected the input.
func isAwgmgrEndpointMissing(err error) bool {
