...
// диагностики (tg/help_panels.go:209, tg/pingcheck_panel.go:144,
// tg/diag_keyboard.go:26); кнопка premium висит только в старых сообщениях --
// её экран теперь отсылает в приложение. Панели уходят только в цикле 4. До тех пор кнопка обязана отвечать.
//
