...
func (r *Router) handleKeyboardCommand(ctx context.Context, m *tg.Message) {
	...
	if err := alerts.RepushRoleMenu(ctx, r.tg, m.Chat.ID, *m.MessageThreadID, u.Nickname, tg.ReplyKeyboardForTopic("per_router"), tg.OperatorMenuInlineKeyboardForTopic("per_router")); err != nil {
