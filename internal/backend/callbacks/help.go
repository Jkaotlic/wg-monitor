...
👤 Ты — оператор.
Работай только в топиках роутеров, куда тебя добавили. Можно смотреть статус, запускать проверки, управлять туннелями/маршрутами и обслуживанием этого топика. Кабинеты VPN — в приложении.
