...
// NoAttempt -- отказ не по вине оживления (Fix round 1, Minor #3: движок
// переустановки занят чужим заданием на этом же роутере, например дашборд
// уже чинит или ставит) -- воркер не тратит на него одну из пяти попыток.
// Никогда не бывает true одновременно с Permanent.
